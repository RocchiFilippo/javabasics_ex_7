...
public class Main {
    ...
    private static void exercise1() {
        ...
        String fullName = "FiLiPpO rOcChI";

        System.out.println("upper case = " + fullName.toUpperCase() + ", lower case = " + fullName.toLowerCase());
    ...
    private static void exercise2() {
        ...
        String middleName = "Gianmaria";
        String lastName = "Rocchi";
    ...
    private static void exercise3() {
        System.out.println("\nExercise 3:");
        //in String type variables the values are merged in a single String
